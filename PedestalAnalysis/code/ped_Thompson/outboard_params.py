...
def main():
    ...
    for transition in ['LH','HL']:
        ...
        for shot in transition_data.index:
            ...
            # loop over every time in the thompson time array
            for t in times.t.values:
                ...
                # filter to the outer pedestal region
            ...
            writer = pd.ExcelWriter('../../data/pedestal_fit/'+transition+f'/outboard_{shot}.xlsx',engine='xlsxwriter')
